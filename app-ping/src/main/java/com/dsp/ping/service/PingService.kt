 ...
 * Смена периода в Settings подхватывается на лету: Rx-таймер перезапускается.
 */
class PingService : Service() {
    ...
    /**
     * Окно подавления дубля вокруг границы: не больше половины периода,
     * иначе при периоде 1 сек гасились бы сами границы.
     */
